...
function toFixtureResult(
  ...
  return {
    ...
    locatingPins: result.featureSummary.locatingPinCount,
    clamps: result.featureSummary.clampCount,
    keepoutRegions: result.featureSummary.keepoutRegionCount,
    solderWindows: result.featureSummary.solderWindowCount,
    springClips: result.featureSummary.springClipCount || 0,
